...
//Answer: i  would use const vs. let so that the value cant be changed or redeclared
...
//Answer: the sentence would look the same but with out the necessary "spaces" making it look like one long word. lol  

console.log("My friend" + friendsName + "&" + myName + "are eating" + food); 
...
//Answer: It means that since drink was declared as a const it will never be allowed to be reassigned later on in the code
...
console.log(foodForTodayAndTomorrow("burger, soda", lunchTime("cheese, juice")));
